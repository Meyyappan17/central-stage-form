...
const LeadCard = ({ lead, onClick }: LeadCardProps) => {
  return (
    <div
      onClick={onClick}
      className="cursor-pointer w-72 h-80"
    >
      <div className="w-full h-full bg-card border border-border rounded-2xl p-6 shadow-soft hover:shadow-input transition-shadow flex flex-col">
        {/* Service Badge */}
